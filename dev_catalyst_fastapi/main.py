...
# FastAPIアプリケーションの作成
app = FastAPI(
    title="DevCatalyst AI API", description="AI-powered development assistance API", version="1.0.0"
)
...
@app.get("/")
async def root():
    return {"message": "DevCatalyst AI API", "version": "1.0.0", "status": "running"}
