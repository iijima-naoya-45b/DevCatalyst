      ...
      switch (error) {
        ...
        case 'registration_failed':
          info = {
            ...
            solution:
              'メールアドレスが既に使用されている可能性があります。ログインを試すか、別のメールアドレスをお使いください。',
        ...
        case 'oauth_configuration_error':
          info = {
            ...
            solution:
              '開発者にお問い合わせください。一時的にメールアドレスでのログインをお試しください。',
        ...
        case 'oauth_failed':
          info = {
            ...
            solution:
              'ブラウザのポップアップブロックを無効にして再試行するか、メールアドレスでのログインをお試しください。',
            technical: `Error Code: ${error}`,
          };
          break;
        default:
          ...
          <CardContent className="space-y-6">
            ...
            {errorInfo.solution && (
              <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
                ...
                <p className="text-sm text-blue-800 dark:text-blue-200">{errorInfo.solution}</p>
              </div>
            )}
