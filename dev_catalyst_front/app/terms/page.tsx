        ...
        <div className="bg-white/95 dark:bg-black/80 backdrop-blur-md rounded-2xl shadow-2xl border border-gray-200/50 dark:border-gold/20 p-8 md:p-12">
          ...
          <div className="prose prose-gray dark:prose-invert max-w-none space-y-8 text-gray-900 dark:text-gray-100">
            ...
            <section>
              ...
              <ol className="list-decimal list-inside space-y-2 text-gray-700 dark:text-gray-300">
                <li>本サービスを通じてAIが生成したコンテンツ（コード、ドキュメント、分析結果等）の知的財産権は、生成を指示したユーザーに帰属します。ただし、当該帰属は、本サービスの基盤となる外部AIサービス提供元の利用規約に反しない範囲で適用されるものとします。</li>
                <li>ただし、AI生成コンテンツの品質、正確性、完全性、有用性について、当社は一切の保証を行いません。</li>
                <li>ユーザーは、AI生成コンテンツを商用・非商用を問わず自由に利用、改変、配布することができます。ただし、ユーザーは、当該利用にあたり、外部AIサービス提供元の利用規約および適用法令を遵守するものとします。</li>
              ...
              <div className="mt-4">
                ...
                <ol className="list-decimal list-inside space-y-2 text-gray-700 dark:text-gray-300">
                  <li>ユーザーは、本サービスのAI機能を利用するにあたり、当社が外部AIサービス（OpenAI 等）のAPI連携を通じてAI機能を提供していること、および当該AI機能の品質、正確性、利用可能性が外部AIサービスの仕様、利用規約または制限に左右されることを承諾するものとします。</li>
                  <li>外部AIサービスの規約、仕様または提供状況が変更された場合、当社はユーザーへの事前通知なく、本サービスのAI機能の一部または全部を変更、停止または終了することができるものとします。</li>
                  <li>ユーザーが外部AIサービスの利用規約に違反する行為を行ったことにより当社が損害を被った場合、ユーザーは当該損害を賠償する責任を負うものとします。</li>
                </ol>
              </div>
            </section>
            ...
            <section>
              ...
              <ol className="list-decimal list-inside space-y-2 text-gray-700 dark:text-gray-300">
                ...
                <li className="space-y-1">
                  <span className="font-semibold text-gray-900 dark:text-white">（ユーザーによる入力データの権利保証）</span>
                  <p>ユーザーは、本サービスに入力、アップロードまたは送信する一切のデータ（以下「入力データ」といいます）について、自己が適法な権利を有し、第三者の知的財産権、プライバシー権その他の権利を侵害していないことを当社に対し保証するものとします。入力データに関し第三者との間で紛争が生じた場合、ユーザーは自己の責任と費用をもってこれを解決し、当社にいかなる迷惑または損害も与えないものとします。</p>
                </li>
                ...
                <li className="space-y-1">
                  <span className="font-semibold text-gray-900 dark:text-white">（秘密保持義務）</span>
                  <p>当社は、ユーザーが本サービスを通じて入力したプロジェクト情報、対話履歴その他の利用データ（以下「ユーザー機密情報」といいます）を機密情報として厳重に管理し、本サービスの提供および改善、または本規約で明示的に許容された目的以外に、ユーザーの事前の書面による同意なく利用し、または第三者に開示しません。ただし、法令に基づき開示が義務付けられる場合または裁判所その他公的機関の命令により開示が必要な場合にはこの限りではありません。その際、当社は可能な限り速やかに当該開示の内容および理由をユーザーに通知するよう努めます。</p>
                </li>
              </ol>
            </section>
            ...
            <section>
              ...
              <ol className="list-decimal list-inside space-y-2 text-gray-700 dark:text-gray-300">
                ...
                <li>当社は、将来的に有料プラン（以下「有料サービス」といいます）を導入する場合、事前にユーザーへ通知し、料金体系、支払方法、契約期間、自動更新の有無を明示します。</li>
                <li>有料サービスへの移行は、ユーザーの明示的な同意を必要とします。</li>
                <li>ユーザーは、有料サービスの利用料金を当社が指定する方法により、当社の指定する期日までに支払うものとします。支払いが確認できない場合、当社は第7条に定める規定にかかわらず、当該ユーザーへの本サービスの一部または全部の提供を停止することができます。</li>
                <li>ユーザーは、有料サービスの契約期間中であっても解約することができます。ただし、法令に別段の定めがある場合を除き、既に支払われた利用料金および残存期間に対応する利用料金は返金されません。</li>
              </ol>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 dark:text-gray-300">
                当社は、本サービスの利用によって取得する個人情報については、適用される法令および当社の「プライバシーポリシー」に従い適切に取り扱うものとします。当社のプライバシーポリシーには、GDPR を含む国際的なデータ保護規制に基づくデータ主体の権利およびその行使方法に関する情報が含まれます。
              </p>
            </section>
            ...
            <section>
              ...
              <ol className="list-decimal list-inside space-y-2 text-gray-700 dark:text-gray-300">
                <li>本サービスの利用において、欧州経済領域（EEA）その他日本国外のデータ保護法が適用される場合、当社はプライバシーポリシーに定める範囲で適用法令を遵守します。</li>
                <li>ユーザーが EEA 域内の個人データを本サービスへ入力する場合、ユーザーはデータ管理者として当該データ処理の適法性を確保するものとし、当社はユーザーの指示および本規約ならびにプライバシーポリシーに従うデータ処理者として当該データを取り扱います。</li>
                <li>ユーザーは、本サービスの提供に伴い、プロジェクト情報が日本国および外部 API 提供元の所在国へ移転される場合があることをあらかじめ承諾するものとします。</li>
              </ol>
            </section>
