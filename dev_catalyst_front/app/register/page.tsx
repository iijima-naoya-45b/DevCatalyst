...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative">
      ...
      <div
        className="fixed bottom-0 right-1/4 w-64 h-64 bg-pink-200/10 dark:bg-indigo-950/8 rounded-full blur-2xl animate-pulse-slow -z-10"
      ...
      <div className="max-w-xl w-full space-y-8">
        <div className="text-center">
          ...
          <h1 className="text-3xl font-serif font-bold gold-soft-text mb-2">devCatalyst</h1>
        ...
        <Card className="shadow-2xl border-0 bg-white/95 dark:bg-black/80 backdrop-blur-md dark:border dark:border-gold/20">
          <CardHeader className="text-center pb-8 pt-10">
            <CardTitle className="text-3xl font-serif text-gray-900 dark:text-white mb-3 tracking-tight">
              新規登録
            </CardTitle>
          ...
          <CardContent className="space-y-8 px-8 pb-10">
            ...
            <div className="relative py-4">
              ...
              <div className="relative flex justify-center">
                <span className="bg-white dark:bg-black/80 px-6 text-xs text-gray-400 dark:text-gray-500 uppercase tracking-wider">
                  または
                </span>
              </div>
            </div>
