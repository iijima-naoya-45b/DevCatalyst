          ...
          <div className="prose prose-gray dark:prose-invert max-w-none space-y-8 text-gray-900 dark:text-gray-100">
            ...
            <section>
              ...
              <ol className="list-decimal list-inside space-y-2 text-gray-700 dark:text-gray-300">
                ...
                <li>EU圏内のユーザーの個人データについては、GDPR第6条に基づく法的根拠（ユーザーの同意または契約の履行のためなど）に基づき処理を行います。</li>
            ...
            <section>
              ...
              <ol className="list-decimal list-inside space-y-2 text-gray-700 dark:text-gray-300">
                ...
                <li>EU圏内のユーザーから収集した個人情報の国際転送については、GDPR（EU一般データ保護規則）に準拠した適切な保護措置（欧州委員会が承認した標準契約条項（SCC）の締結、十分性認定の活用その他の適切な法的メカニズム等）を講じます。</li>
            ...
            <section>
              ...
              <ol className="list-decimal list-inside space-y-2 text-gray-700 dark:text-gray-300">
                ...
                <li>アカウント削除の要求があった場合、30日以内に個人情報を削除します。ただし、以下の情報は例外とします。
                  <ul className="list-disc list-inside ml-6 mt-2 space-y-1">
                    <li>法令により保存が義務付けられている情報（例：日本の税法・商法に基づき最低7年間の保存が求められる取引記録等）</li>
