            ...
            <div className="prose prose-gray dark:prose-invert max-w-none space-y-8 text-gray-900 dark:text-gray-100">
              ...
              <section>
                ...
                <ol className="list-decimal list-inside space-y-2 text-gray-700 dark:text-gray-300">
                  <li>
                    当社は、外部AI
                    API（OpenAI等）を利用して、ユーザーの入力データに基づきコンテンツを生成します。
                  </li>
                  <li>
                    ユーザーがAI機能を使用する際に入力した情報は、外部AI
                    APIプロバイダーに送信されます。
                  </li>
                  <li>
                    当社は、信頼できるAI
                    APIプロバイダーを選定し、それらのプロバイダーがユーザーデータをAIモデルの学習に使用しない設定を適用しています。
                  </li>
                  <li>
                    EU圏内のユーザーの個人データについては、GDPR第6条に基づく法的根拠（ユーザーの同意または契約の履行のためなど）に基づき処理を行います。
                  </li>
                  <li>
                    AI生成コンテンツの権利はユーザーに帰属しますが、当社はサービス改善のため、匿名化された利用データを統計分析に使用することがあります。
                  </li>
                  <li>
                    ユーザーは、AI機能を使用することにより、上記のデータ処理に同意したものとみなされます。
                  </li>
                </ol>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-700 dark:text-gray-300 mb-2">
                  当社は、以下のサービスプロバイダーに業務を委託し、個人情報を提供する場合があります。
                </p>
                <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300 ml-4">
              ...
              <section>
                ...
                <ol className="list-decimal list-inside space-y-2 text-gray-700 dark:text-gray-300">
                  <li>
                    本サービスは、ユーザー体験の向上、セッション管理、認証のためにCookieを使用します。
                  </li>
                  <li>
                    当社が使用するCookieの種類：
              ...
              <section>
                ...
                <ol className="list-decimal list-inside space-y-2 text-gray-700 dark:text-gray-300">
                  ...
                  <li>
                    当社が利用する一部のサービスプロバイダーは、日本国外にサーバーを有する場合があります。
                  </li>
                  <li>
                    EU圏内のユーザーから収集した個人情報の国際転送については、GDPR（EU一般データ保護規則）に準拠した適切な保護措置（欧州委員会が承認した標準契約条項（SCC）の締結、十分性認定の活用その他の適切な法的メカニズム等）を講じます。
                  </li>
              ...
              <section>
                ...
                <ol className="list-decimal list-inside space-y-2 text-gray-700 dark:text-gray-300">
                  ...
                  <li>
                    アカウント削除の要求があった場合、30日以内に個人情報を削除します。ただし、以下の情報は例外とします。
                    <ul className="list-disc list-inside ml-6 mt-2 space-y-1">
                      <li>
                        法令により保存が義務付けられている情報（例：日本の税法・商法に基づき最低7年間の保存が求められる取引記録等）
                      </li>
                      <li>不正利用防止のために必要な最低限の情報（匿名化された形式）</li>
                    </ul>
                  </li>
                  <li>
                    匿名化された統計データは、サービス改善のため無期限に保持する場合があります。
                  </li>
                </ol>
              </section>
              ...
              <section>
                ...
                <ol className="list-decimal list-inside space-y-2 text-gray-700 dark:text-gray-300">
                  <li>
                    <strong>アクセス権</strong>：当社が保有する個人情報の開示を請求する権利
                  </li>
                  <li>
                    <strong>訂正権</strong>：不正確な個人情報の訂正を請求する権利
                  </li>
                  <li>
                    <strong>削除権（忘れられる権利）</strong>：個人情報の削除を請求する権利
                  </li>
                  <li>
                    <strong>処理の制限権</strong>：個人情報の処理を制限する権利
                  </li>
                  <li>
                    <strong>データポータビリティ権</strong>
                    ：個人情報を構造化された一般的な形式で受け取る権利
                  </li>
                  <li>
                    <strong>異議申立権</strong>：個人情報の処理に異議を申し立てる権利
                  </li>
                  <li>
                    <strong>自動処理に関する権利</strong>
                    ：自動化された意思決定（AI分析等）に異議を申し立てる権利
                  </li>
                </ol>
              ...
              <section>
                ...
                <ol className="list-decimal list-inside space-y-2 text-gray-700 dark:text-gray-300">
                  ...
                  <li>
                    万が一、個人情報の漏洩が発生した場合、速やかに該当ユーザーおよび監督官庁に通知します。
                  </li>
                </ol>
              </section>
              ...
              <section>
                ...
                <ol className="list-decimal list-inside space-y-2 text-gray-700 dark:text-gray-300">
                  ...
                  <li>
                    変更後のプライバシーポリシーは、本サービス上に掲載された時点で効力を生じます。
                  </li>
                  <li>
                    変更後も本サービスを利用し続けることで、変更に同意したものとみなされます。
                  </li>
                </ol>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  本プライバシーポリシーは、日本法に準拠し、解釈されます。EU圏内のユーザーについては、GDPRの規定も適用されます。本ポリシーに関して紛争が生じた場合、利用規約第13条の定めに従い、当社の本店所在地を管轄する裁判所を専属的合意管轄裁判所とします。
                </p>
              </section>
              ...
              <section className="mt-12 pt-8 border-t border-gold/20">
                ...
                <div className="mt-4 p-4 bg-gray-50 dark:bg-slate-900/50 rounded-lg">
                  <p className="text-gray-700 dark:text-gray-300">
                    <strong>運営者：</strong>DevCatalyst運営チーム
                    <br />
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
                    ※
                    個人情報に関するご請求の場合、ご本人確認のため追加情報をお願いする場合があります。
                    <br />※ 通常、2営業日以内に回答いたします。
                  </p>
                </div>
              </section>
