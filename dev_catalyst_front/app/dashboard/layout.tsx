...
export default function DashboardLayout({
    ...
    return (
        <div className="min-h-screen flex flex-col bg-gradient-to-b from-purple-50/30 via-pink-50/20 to-rose-50/30 dark:bg-gradient-to-br dark:from-black dark:via-slate-950 dark:to-black">
            ...
            <div className="fixed bottom-0 right-1/4 w-64 h-64 bg-pink-200/10 dark:bg-indigo-950/8 rounded-full blur-2xl animate-pulse-slow z-0" style={{ animationDelay: '2s' }} />
            <div className="fixed top-1/2 right-1/3 w-80 h-80 bg-rose-100/8 dark:bg-slate-800/5 rounded-full blur-3xl animate-pulse-slow z-0" style={{ animationDelay: '1s' }} />
