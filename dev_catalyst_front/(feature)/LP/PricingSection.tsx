            ...
            >
              {plan.popular && (
                <div className="absolute -top-3 sm:-top-4 left-1/2 transform -translate-x-1/2">
                  <Badge className="gold-soft-gradient px-4 sm:px-6 py-1 sm:py-2 text-xs sm:text-sm text-aria-dark-soft shadow-[0_12px_25px_-12px_rgba(15,23,42,0.35)]">
              ...
              <CardContent className="space-y-4 sm:space-y-6 px-4 sm:px-6">
                ...
                <Button
                  ...
                  className="w-full h-10 sm:h-12 aria-gold-surface text-sm sm:text-base"
                >
                  {plan.cta}
                </Button>
              </CardContent>
