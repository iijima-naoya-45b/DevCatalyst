    ...
    <section className="py-20 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h3 className="text-4xl font-serif font-semibold mb-6 text-foreground dark:text-white">
            今夜から、アリアと話せます
          </h3>
              ...
              return (
                <div key={step.step} className="text-center relative">
                  ...
                  <div className="space-y-2">
                    ...
                    <h4 className="text-lg font-semibold text-foreground dark:text-white">{step.title}</h4>
                    <p className="text-sm text-muted-foreground dark:text-gray-300">{step.description}</p>
                    <Badge variant="outline" className="border-gold/30 dark:border-gold-light/50 text-gold dark:text-gold-light text-xs bg-white/10 dark:bg-black/20">
