  ...
  return (
    <section ref={ref} className="py-20 px-4 bg-white dark:bg-slate-900">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Dashboard Preview */}
        <div className={`relative max-w-6xl mx-auto mb-16 scale-in ${isInView ? 'in-view delay-200' : ''}`}>
        ...
        {/* Benefits */}
        <div className={`grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto fade-in-up ${isInView ? 'in-view delay-400' : ''}`}>
