  ...
  if (!mounted) {
    return (
      <header className="p-4 bg-white text-gray-900 border-b border-gray-200 shadow-sm dark:bg-slate-900 dark:text-foreground dark:border-gold/30">
        <div className="mx-auto w-full max-w-[1600px] h-12 flex items-center justify-between">
          ...
          {authenticated ? (
            ...
            <ul className="flex space-x-4">
              <li>
                <a
                  href="#"
                  className="hover:underline text-gray-700 dark:text-gray-300 hover:gold-soft-text"
                >
                  Home
                </a>
              </li>
          ...
          <div className="mx-auto w-full max-w-[1600px] space-y-2">
            <button
              ...
              className={`w-full text-left px-4 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors flex items-center gap-2 ${
                isActive('/dashboard')
                  ? 'gold-soft-text font-semibold bg-gold/10'
