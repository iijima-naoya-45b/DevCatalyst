...
export function ThemeToggleAnimated() {
    ...
    return (
        <button
            ...
            className={`relative inline-flex h-12 w-24 items-center rounded-full transition-all duration-500 hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:ring-offset-2 ${isDark
        ...
        >
            ...
            <div className="absolute inset-0 rounded-full overflow-hidden">
                ...
                {!isDark && (
                    <>
                        <div className="absolute top-2 left-3 w-2 h-1 bg-white/60 rounded-full animate-pulse" style={{ animationDelay: '0s' }} />
                        <div className="absolute top-3 right-4 w-1.5 h-0.5 bg-white/40 rounded-full animate-pulse" style={{ animationDelay: '1s' }} />
                    </>
                )}
                ...
                {isDark && (
                    <>
                        <Stars className="absolute top-2 left-3 h-2 w-2 text-yellow-300 animate-pulse" style={{ animationDelay: '0s' }} />
                        <div className="absolute top-3 right-5 w-1 h-1 bg-yellow-200 rounded-full animate-pulse" style={{ animationDelay: '0.5s' }} />
                        <div className="absolute bottom-3 left-5 w-0.5 h-0.5 bg-blue-200 rounded-full animate-pulse" style={{ animationDelay: '1.5s' }} />
                    </>
                )}
            </div>
